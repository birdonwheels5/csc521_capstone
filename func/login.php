...
function create_user($username, $password, $email, $authority_level)
{
    ...
    $insert = "INSERT INTO `" . $GLOBALS['mysql_database'] . "`.`users` (`user_id_num`, `username`, `uuid`, `hashed_password`, `new_hashed_password`, `salt`, `authority_level`, `creation_time`, `last_login`, `email`, `validate`, `session_id`) VALUES (0, '$username', '$uuid', '$hashed_password', '', '$salt', '$authority_level', '$creation_time', '0', '$email', '0', '');";
