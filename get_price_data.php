...
function get_price_data($con, $exchange, $timespan)
{
    ...
    $max_result = mysqli_query($con, "SELECT `$exchange` FROM (SELECT `$exchange` FROM Price_History ORDER BY tstamp DESC LIMIT 16, 8) `$exchange` ORDER BY `$exchange` ASC LIMIT 1;");
