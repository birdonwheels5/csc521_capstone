...
<body class="color-0" onresize="update_chart()" onload="$('#li_twitter').css('background-color', active_color);">
	...
	<div class="row"></div>
		...
		<div class="col-4"> <!-- Column 1 -->
			...
			<div class="object shadow">
				...
				<a href="chart.php"><div class="chart" id="chart_div"></div></a>
				
				<form action="javascript:void(0);" onsubmit="update_chart()" name="chart_settings" method="post" onchange="update_chart()" class="row chart">
