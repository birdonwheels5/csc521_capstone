		...
		<center><div class="container">
			...
			<article style="color:#FFFFFF;">
				<p>
					...
					<hr/>
					<center><h1>Post Edit Error</h1></center>
					<hr/>
					<p>
						<div class="box">
							<p>
								<?php
                                    ...
                                    {
                                        $result = edit_post($subject, $content, $post_id);
                                        ...
                                        {
                                            print "Edit failed! Are you trying to <a href =\"bulletin.php#create\">create a new post?</a>";
                                        }
                                    }
